            ...
            <main>
                ...
                <section className='gradient mb-[100px] md:mb-[190px]'>
                    <div className="container mx-auto p-[25px] md:px-0">
                        ...
                        <div style={styles} className='h-[350px] md:h-[556px] text-white p-4 md:px-8 md:pb-[52px] flex flex-col lg:flex-row lg:items-end justify-end relative overflow-hidden'>
                        ...
                        <div className='items-center justify-between mt-[21px] hidden md:flex'>
